...
qc <- misreadQC(
    ...
    n_steps = 2000,
    n_forks = 5,
    step_size_range = c(0.075, 0.0025), # max and min step size for MCMCSA, will be decayed linearly over n_steps
    temp_range = c(0.1, 0.0025), # max and min temperature for MCMCSA, will be decayed linearly over n_steps
